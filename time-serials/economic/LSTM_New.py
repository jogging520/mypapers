...
def split_dataset(data, time_step):
    ...
    if(time_step!=0):
        train = array(array_split(train, len(train) / time_step))
        test =  array(array_split(test,  len(test) /  time_step))
    return train,test
...
def build_model(train, n_input):
    ...
    # train_x, train_y = train[:, :-n_input], train[:, -n_input:]
